        ...
        <Card className="flex flex-col rounded-xl">
          <CardHeader className="flex-row items-center justify-between p-3 border-b">
            ...
            <Button
              ...
              variant="ghost"
              size="icon"
              className="text-destructive hover:bg-destructive/10 hover:text-destructive rounded-full h-8 w-8"
            >
        ...
        <Card className="flex flex-col h-full bg-card rounded-xl">
          ...
          <CardFooter className="bg-card pt-6">
            <form onSubmit={handleSendMessage} className="flex w-full gap-2">
              ...
              <Button
                type="submit"
                disabled={status === "loading" || !currentMessage.trim()}
              >
                {status === "loading" ? (
